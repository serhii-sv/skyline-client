...
final class Permissions extends Enum
{
    ...
    const LANGUAGE_INDEX   = 'lang.index';
    const LANGUAGE_STORE  = 'lang.store';
    const LANGUAGE_DESTROY  = 'lang.destroy';
    const LANGUAGE_UPDATE    = 'lang.update';
    ...
    public static $data = [
        ...
        self::LANGUAGE_INDEX => 'Список языка',
        self::LANGUAGE_STORE => 'Добавление языка',
        self::LANGUAGE_DESTROY => 'Удаление языка',
        self::LANGUAGE_UPDATE => 'Изменение языка'
    ];
}
